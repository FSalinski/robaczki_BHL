...
## Eksperymenty sprawdzające czy rozwiązanie ma sens
...
![AUC test](src/plots/auc_test.png)

![EAUG full](src/plots/eaug_full.png)

![Total emissions](src/plots/total_emissions.png)

![Total time](src/plots/total_time.png)
